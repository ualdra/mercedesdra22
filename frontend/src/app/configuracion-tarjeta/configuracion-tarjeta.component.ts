...
export class ConfiguracionTarjetaComponent implements OnInit {
  ...
  @Input() nombre="Cuero"  //Insertar el nombre s
  @Input() descripcion="Tapizado en cuero marrón " //Insertar la descripción
  @Input() precio="26570 €" //insertar el precio
  @Input() imagen="https://www.polipiel.com/server/Portal_0007615/img/products/solar-color-marron-oscuro_995892.jpg" //Aqui colocar la imagen
